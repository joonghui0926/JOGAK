...
def build_refine_prompt(
    *,
    ...
    return (
        ...
        "for placement intent. Preserve the original figurine identity, pose, proportions, outfit, base design, and the "
        "recognizable silhouette, color, texture, and motif of every unlocked part. Keep the character face clean and "
        ...
        "character, place it as background scenery while keeping its shape and scale recognizable. If a ceramic, tool, tag, scroll, or prop is placed "
